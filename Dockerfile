...
#ENV REACT_APP_URL_BACKEND=https://ui.asset-forome-0b8a4e8de101bcbaf4eafc441eda83b3-0000.us-south.containers.appdomain.cloud/anfisa/app
ENV REACT_APP_URL_BACKEND=https://qa.asset-forome-dev-162fa491ef10b14d22843708d94ef0ba-0000.us-south.containers.appdomain.cloud/anfisa/app
RUN ["yarn", "install"]
RUN ["yarn", "build"]
