...
Scenario:01 Text editor can be opened when there are no data in the decision tree
...
Scenario:03 Dark mode saves after the dialog is closed
	Given the "Text editor" was open
...
Scenario:04 Light mode can be turned on
	Given the "Text editor" was open
...
Scenario:05 Light mode saves after the dialog is closed
	Given the "Text editor" was open
...
Scenario Outline:08 Save changes locally via Done button
	Given the "Text editor" was open
...
Examples:
	...
	| Callers             | GATK_DE_NOVO         | Variant_Class       | deletion             |

		
Scenario Outline:10 "Drop changes" button
	Given the "Text editor" was open
...
Scenario:11 Add the second step via DTree when the first step was removed and this changes were saved locally
	Given the "Text editor" was open
	And two attributes were added to the first step
...
Scenario:13 Try to save with invalid boolean value
	Given "Decision Tree Panel" was open for an XL dataset
...
Scenario:14 Try to save with invalid word instead of "return"
	Given the "Text editor" was open
	And data were valid
...
Scenario:15 Back from invalid data to valid
	Given the "Text editor" was open
...
Scenario:16 Clear all data manually: invalid case
...
Scenario:17 Add non-existed value to the attribute
	Given the "Text editor" was open
...
Scenario:18 Clear all data manually: valid case
	Given the "Decision Tree panel" was open for the XL dataset
	When the user clicks the "Text editor" button
...
Scenario Outline:19 Copy 100 rows
	Given "Decision Tree Panel" was open for an XL dataset
	When the user clicks the "Add attribute" button on the first step
	And the "Add attribute" dialog is open
...
Scenario:20 Enter a decision tree manually
