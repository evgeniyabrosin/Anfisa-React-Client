Feature: Filter Refiner, Filter by Locus (GeneRegion)
	...
	Scenario Outline: Add a valid locus - Secondary dataset
		...
		And variants list shoyld be filtered
...
#		| xl_PGP3140_wgs_NIST-4_2 | chr3:25192-chr3:25605 | 3                |
	...
	Scenario Outline: Add a valid locus - Primary dataset
	...
	Scenario Outline: Add an Invalid locus
		Given the Filter Refiner for the "PGP3140_wgs_panel_hl" was open
		When the user clicks the "GeneRegion" attribute
	...
	Scenario Outline: Add an Empty locus
		Given the Filter Refiner for the "PGP3140_wgs_panel_hl" was open
		When the user clicks Edit Filters
		And clicks the "GeneRegion" attribute
	...
	Scenario Outline: Clear button
		...
		And Varians number should be updated
