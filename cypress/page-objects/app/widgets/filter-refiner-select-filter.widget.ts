...
export class FilterRefinerFilterWidget extends UIWidget {
  ...
  constructor(options: { selectors: FilterRefinerFilterSelectors; labels: FilterRefinerFilterLabels }) {
    super(options)
    ...
    this.filterElements = new Label(selectors.filterElements, labels.filterElements)
