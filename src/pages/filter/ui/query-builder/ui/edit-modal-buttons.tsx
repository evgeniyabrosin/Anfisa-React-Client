...
export const EditModalButtons = observer(({ handleClose, disabled, handleSaveChanges }: IProps) => {
    ...
    <div className="flex justify-between items-center">
      ...
      <div className="flex">
        ...
        <div className="relative">
          <Button disabled={disabled} text={t('dtree.saveChanges')} onClick={handleSaveChanges} />
        </div>
      </div>
    </div>
  )
